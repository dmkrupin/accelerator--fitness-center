...
/* harmony import */ var _modules_init_videos__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/init-videos */ "./js/modules/init-videos.js");
/* harmony import */ var _modules_init_trainer_cards__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/init-trainer-cards */ "./js/modules/init-trainer-cards.js");
/* harmony import */ var _modules_init_swipers__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/init-swipers */ "./js/modules/init-swipers.js");
...
/* harmony import */ var _modules_form_validation__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/form-validation */ "./js/modules/form-validation.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_init_videos__WEBPACK_IMPORTED_MODULE_2__["initVideos"])(); // Modules
  // ---------------------------------
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_init_swipers__WEBPACK_IMPORTED_MODULE_4__["initSwipers"])();
    Object(_modules_init_trainer_cards__WEBPACK_IMPORTED_MODULE_3__["initTrainerCards"])();
    Object(_modules_init_tabs__WEBPACK_IMPORTED_MODULE_5__["initTabs"])();
    Object(_modules_form_validation__WEBPACK_IMPORTED_MODULE_6__["initFormValidation"])();
  });
}); // ---------------------------------
...
/*!***************************************!*\
  !*** ./js/modules/form-validation.js ***!
  \***************************************/
/*! exports provided: initFormValidation */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initFormValidation", function() { return initFormValidation; });
...
__webpack_require__(/*! ../vendor/swiper */ "./js/vendor/swiper.js");

var reviewsSwiperPrevSlideButton = document.querySelector('.reviews__swiper-button-prev');
var reviewsSwiperNextSlideButton = document.querySelector('.reviews__swiper-button-next');
var trainersSwiperPrevSlideButton = document.querySelector('.trainers__swiper-button-prev');
var trainersSwiperNextSlideButton = document.querySelector('.trainers__swiper-button-next');
...
var initReviewsSwiper = function initReviewsSwiper() {
  ...
  var reviewsSwiper = new Swiper('.reviews__list .swiper', {
    loop: true,
    spaceBetween: 20
  }); // Навешиваем переключение слайдов по нажатию мышкой на кнопки

  reviewsSwiperPrevSlideButton.addEventListener('click', function () {
    reviewsSwiper.slidePrev();
  });
  reviewsSwiperNextSlideButton.addEventListener('click', function () {
    reviewsSwiper.slideNext();
  }); // Навешиваем переключение слайдов по нажатию Enter на кнопке

  reviewsSwiperPrevSlideButton.addEventListener('keydown', function (evt) {
    if (evt.keyCode === 13) {
      reviewsSwiper.slidePrev();
    }
  });
  reviewsSwiperNextSlideButton.addEventListener('keydown', function (evt) {
    if (evt.keyCode === 13) {
      reviewsSwiper.slideNext();
    }
  });
...
var initTrainersSwiper = function initTrainersSwiper() {
  ...
  var trainersSwiper = new Swiper('.trainers__list .swiper', {
    spaceBetween: 40,
    slidesPerView: 1,
  ...
  trainersSwiperPrevSlideButton.addEventListener('click', function () {
    trainersSwiper.slidePrev();
  });
  trainersSwiperNextSlideButton.addEventListener('click', function () {
    trainersSwiper.slideNext();
  }); // Навешиваем переключение слайдов по нажатию Enter на кнопке

  trainersSwiperPrevSlideButton.addEventListener('keydown', function (evt) {
    if (evt.keyCode === 13) {
      trainersSwiper.slidePrev();
    }
  });
  trainersSwiperNextSlideButton.addEventListener('keydown', function (evt) {
    if (evt.keyCode === 13) {
      trainersSwiper.slideNext();
    }
  });
...
var membershipInfoElementsCollection = document.querySelector('.membership__info').children;
var membershipTabElementsCollection = document.querySelector('.membership__options').children;

var breakpointChecker = function breakpointChecker(element) {
  if (breakpoint.matches) {
...
var hideAllMembershipInfo = function hideAllMembershipInfo() {
  var _iterator = _createForOfIteratorHelper(membershipInfoElementsCollection),
      _step;
...
var deactivateAllMembershipTabsState = function deactivateAllMembershipTabsState() {
  var _iterator2 = _createForOfIteratorHelper(membershipTabElementsCollection),
      _step2;
...
var setMembershipTabs = function setMembershipTabs() {
  var _iterator3 = _createForOfIteratorHelper(membershipTabElementsCollection),
      _step3;

  try {
    for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
      var tab = _step3.value;
      tab.querySelector('a').addEventListener('click', function (evt) {
        evt.preventDefault();
        deactivateAllMembershipTabsState();
        evt.target.parentNode.classList.add('is-active');
        var macthingMembershipInfoElement = document.getElementById(evt.target.href.split('#').pop());
...
var initTabs = function initTabs() {
  ...
  hideAllMembershipInfo();
  breakpointChecker(document.getElementById('1-month-membership')); // активируем переключение табов блока membership
...
/***/ "./js/modules/init-trainer-cards.js":
/*!******************************************!*\
  !*** ./js/modules/init-trainer-cards.js ***!
  \******************************************/
/*! exports provided: initTrainerCards */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initTrainerCards", function() { return initTrainerCards; });
function _createForOfIteratorHelper(o, allowArrayLike) { var it = typeof Symbol !== "undefined" && o[Symbol.iterator] || o["@@iterator"]; if (!it) { if (Array.isArray(o) || (it = _unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = it.call(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it.return != null) it.return(); } finally { if (didErr) throw err; } } }; }
...
var trainerCardElementsCollection = document.querySelectorAll('.trainers__card');

var initTrainerCards = function initTrainerCards() {
  var _iterator = _createForOfIteratorHelper(trainerCardElementsCollection),
      _step;

  try {
    var _loop = function _loop() {
      var card = _step.value;
      var cardInfo = card.querySelector('.trainers__info');
      var cardPhotoHeading = card.querySelector('.trainers__photo h3');
...
function generateURL(id) {
  var query = '?autoplay=1&enable_js=1';
